...
Download for macOS Ventura (13) and higher: [v1.6.13](https://github.com/othyn/macos-auto-clicker/releases/download/v1.6.13/Auto.Clicker.1.6.13.dmg)

Download for macOS Big Sur (11) or Monterey (12): [v1.6.13](https://github.com/othyn/macos-auto-clicker/releases/download/v1.6.13/Auto.Clicker.1.6.13.dmg)
