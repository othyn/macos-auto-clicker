    ...
    var body: some View {
        TabView {
            GeneralSettingsTabView()
                ...
                .onAppear {
                    self.changeFrameHeight(WindowStateService.settingsHeight)
                }
            ...
            KeyboardShortcutsSettingsTabView()
                ...
                .onAppear {
                    self.changeFrameHeight(WindowStateService.settingsHeight / 1.5)
                }
            ...
            WindowSettingsTabView()
                ...
                .onAppear {
                    self.changeFrameHeight(WindowStateService.settingsHeight / 2)
                }
        ...
        .frame(width: WindowStateService.settingsWidth, height: self.frameHeight)
        .padding()
